...
# Touchwiz CRYPTO
PRODUCT_COPY_FILES += \\
   vendor/__MANUFACTURER__/__DEVICE__/proprietary/libsec_km.so:system/lib/libsec_km.so \\
   vendor/__MANUFACTURER__/__DEVICE__/proprietary/libsec_ecryptfs.so:system/lib/libsec_ecryptfs.so \\
   vendor/__MANUFACTURER__/__DEVICE__/proprietary/libkeyutils.so:system/lib/libkeyutils.so
